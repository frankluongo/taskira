    ...
    <div ref={setNodeRef} style={style} className="group">
      <div className="flex items-start gap-3 py-2">
        ...
        <button
          {...attributes}
          {...listeners}
          className="mt-1 cursor-grab touch-none text-gray-300 dark:text-gray-700 hover:text-gray-400 shrink-0"
        >
          <GripIcon />
        </button>
        ...
        <button
          ...
          className="mt-0.5 shrink-0 w-5 h-5 rounded-full border-2 border-gray-300 dark:border-gray-600 hover:border-indigo-500 transition-colors"
        />
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-1 flex-wrap">
            <span
              className={`text-xs font-medium px-1.5 py-0.5 rounded ${priority.color} ${priority.bg}`}
            >
              {priority.label}
            </span>
            {task.due_date && (
      ...
      {expanded &&
        subtasks.map((sub) => (
          <div key={sub.id} className="ml-8 flex items-center gap-3 py-1.5">
            <button
              onClick={() => completeTask(sub.id)}
              className="shrink-0 w-4 h-4 rounded-full border-2 border-gray-300 dark:border-gray-600 hover:border-indigo-500 transition-colors"
            />
