...
const tabs = [
  ...
  { to: '/errands', label: 'Errands', icon: ListIcon },
...
export default function BottomNav() {
  return (
    <nav className="fixed bottom-0 inset-x-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 flex pb-safe">
